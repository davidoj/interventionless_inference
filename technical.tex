...
We say that two random variables are almost surely equal on a particular $\alpha'\in C$ if they are almost surely equal for $\alpha'$ but not necessarily for any other element of $C$:
